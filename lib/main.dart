...
import 'package:jobsheet04/widget/dropdown.dart';
import 'package:jobsheet04/widget/input.dart';
import 'package:jobsheet04/widget/konversi.dart';
import 'package:jobsheet04/widget/result.dart';
import 'package:jobsheet04/widget/riwayat.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Konversi Suhu - (2031710094 - Lailatul Mufida)'),
        ),
        body: Container(
